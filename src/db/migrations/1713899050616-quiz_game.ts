...
export class QuizGame1713899050616 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "player_progress_orm" ADD CONSTRAINT "FK_b63ed4b94999c15e3c20279d62a" FOREIGN KEY ("playerId") REFERENCES "user_orm"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
