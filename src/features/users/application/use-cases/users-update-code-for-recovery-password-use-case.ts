...
export class UsersUpdateCodeForRecoveryPasswordUseCase implements ICommandHandler<UsersUpdateCodeForRecoveryPasswordCommand> {
    constructor (protected usersRepository: UsersRepository,){}

    async execute(command: UsersUpdateCodeForRecoveryPasswordCommand): Promise<string | null> {
        const code = uuidv4();
