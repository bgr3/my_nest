...
export class UsersRepository {
    ...
    async resendConfirmationCode (userId: Types.ObjectId, code: string): Promise<boolean> {
    ...
    async createTokens (userId: Types.ObjectId, tokens: Tokens[]): Promise<boolean> {
    ...
    async updateTokens (userId: Types.ObjectId, oldTokens: Tokens, newTokens: Tokens): Promise<boolean> {
